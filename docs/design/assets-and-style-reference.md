...
~~衬线中文标题、暖黑底 + 金色卡片、卡片化列表、顶栏品牌区。~~ 结论：**维持原有风格**，本节仅作为资料留存。**样式 mockup 已于 2026-09 删除**（方案确定不采用，留着容易误导）。
...
原 `docs/design/style-mockup/index.html`（含 20 张示例贴图与 7 张职业头像）已于 2026-09 删除，
方案确定不采用；如需查看见 git 历史。
